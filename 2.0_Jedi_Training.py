'''
2.0 Jedi Training (20pts)  Name:__Ava_LaMarre_____________

UPLOAD YOUR CH 2 PDF LOG! (6pts)

1.) How do you enter a single line comment in a program? Give an example. (1pt)
#The pound sign is how to make a signle line comment
...
b/a                 = b divided by a, 5/2=2.5
b//a                =2, did not know what it did before, no clue
b**a                =25, I did not think that ** was seting it to the power
b%a                 =1
a+B                 =B is not defined, NameError: name 'B' is not defined
type(42)            = Before I might of thought that it would type out the items in the (), class'int'
type(42.0)          = <class 'flout'>
...
a+=12
a-=7
a             = Prediction(15), Actual(15.0)
type(a)       = Prediction) <Class 'int'>), Actual(<class 'flout'>)
